...
(setq-default mode-line-format
              (list "%e"
                    '(:eval (append
			     (list
			      (powerline-buffer-id    'left   powerline-color1 )
			      (powerline-narrow       'left   powerline-color1
						              powerline-color2 )

			      (powerline-make-text    " "     powerline-color2 )
			      (powerline-display-time 'center powerline-color2 )

			      (powerline-make-text    " "     powerline-color2 )
			      (powerline-lcl          'left   powerline-color2 )
			     ...
			     (powerline-pull-right (list 
				    (powerline-major-mode  'right  powerline-color2 )
				    (powerline-minor-modes 'right  powerline-color2 )
				    (powerline-narrow      'right  powerline-color1
							           powerline-color2 )
